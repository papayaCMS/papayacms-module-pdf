...
/***************************************************
* This version has been modified in order to work  *
* with fonts in other directories. We have created *
* a more flexible method to determine and check    *
* font-file-names and changed code at those points,*
* where fonts are to be loaded.                    *
* The newly created function is found in fpdf.php  *
* and is called _getAbsoluteFontFile.              *
* -------------------------------------------------*
...
/* Changed to work with different directories.
   Alexander Christmann <christmann@papaya-cms.de>
   Thomas Weinert <weinert@papaya-cms.de>
...
*/
  ...
  $file = $this->_getAbsoluteFontFile($font['ctg']);
